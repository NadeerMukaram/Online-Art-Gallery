...
<html lang="en">
  ...
  <body>
	...
	<div class="row">
	<h2 class="pb-2 border-bottom"><i class="fa-solid fa-heart"></i> <?php echo $currentuser['username'];?>'s Favorites</h2> 
	...
	?> 	
            ...
            <div class="col-md-3 col-6 drawingcard" style="margin-bottom: 10px;">

              <div class="card mb-6 box-shadow">
			  
			  	<td class="col-md-2 close-btn">
				<a style="padding: 10px;" href="index.php?del=<?php echo $row['wid'];?>" onClick="return confirm('Are you sure you want to remove <?php echo $row['name']; ?> as your favorite?')" class=""><i class="fa fa-times"></i></a>
				</td>
				
                <a href="../view/index.php?view&id=<?php echo $row['id']?>"><img class="card-img-top img-fit-poggers-for-favorites" src = "<?php echo $pp ?>" alt="Card image cap"></a>
				<div class="card-body">
