<?php 
	...
	if (!isset($_SESSION['username'])) {
		...
		$queryUpdate = "UPDATE comments SET usercomments = '$updatecomment' where id = $updatecommentid";
...
<div class="container">
  ...
  <form name="myForm" onsubmit="return validateForm()" class="form-inline" action="../../admin/updatephp/update_comment.php" method="post">
