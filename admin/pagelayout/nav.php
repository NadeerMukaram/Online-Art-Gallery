 ...
 <nav class="py-2 bg-light border-bottom">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="../discover/" class="nav-link link-dark px-2">Discover</a></li>
      </ul>
      <ul class="nav">
  ...
  <header class="py-3 mb-4 border-bottom">
    <div class="container d-flex flex-wrap justify-content-center">
      ...
      <form  action="./searchuserordrawing.php" method="POST" class="col-12 col-lg-auto mb-3 mb-lg-0" style="display: flex; align-items: center;">
        <input type="text" name="user" class="form-control-nzro" placeholder="Search Artwork" aria-label="">
